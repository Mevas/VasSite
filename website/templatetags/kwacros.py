#
# templatetags/kwacros.py - Support for kwacros in Django templates
#
# Based on snippet by
...
4) Alternatively save your kwacros in a separate
   file, e.g. "mymacros.html" and load it to the
   current template with:
        {% loadkwacros "mymacros.html" %}
   Then use these loaded kwacros in {% usekwacro %}
   as described above.
